	...
	<div id="tabs-2">
		{* PHP *}
		  ...
		  <div style="display:block;border: 1px solid #cccccc;">
	          ...
	          <span style="display:block;"><a href="javascript:void(0);" onclick="$('#se_debug_benchmark_details_{$benchmark_label}').css('display', ( $('#se_debug_benchmark_details_{$benchmark_label}').css('display')=='none' ? '' : 'none') );">Details</a></span>
		    ...
		    <table cellpadding='0' cellspacing='0'>
		      <tr>
		        ...
		        <td style="padding: 5px 10px 5px 10px;">
		          ...
		          <span style="display:block;"><a href="javascript:void(0);" onclick="$('#se_debug_sql_query_{$database->log_data[stat_loop].index}').css('display', ( $('#se_debug_sql_query_{$database->log_data[stat_loop].index}').css('display')=='none' ? '' : 'none') );">Details</a></span>
		          <div id="se_debug_sql_query_{$database->log_data[stat_loop].index}" style="display:none;">
		            ...
		            {/section}
		            <span style="display:block;">Query: {$database->db_sql_format($database->log_data[stat_loop].query)}</span>
		          </div>
		        </td>
		      </tr>
		    </table>
...
<script src="{$PG_URL_HOMEPAGE}templates/admin/js/debug.js"></script>
